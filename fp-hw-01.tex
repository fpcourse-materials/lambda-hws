...
\begin{document}
    ...
    Репозиторий с исходниками можно скачать с \href{https://github.com/fpcourse-materials/lambda-hws}{github}.
    ...
    Найдите все свободные переменные, а также обозначьте, к какому связывателю относится каждая связанная (это удобнее всего сделать с помощью индексов, например, $\lambda x_1\ldotp x_1$).
