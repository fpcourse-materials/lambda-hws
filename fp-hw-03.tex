...
\fancyhead[L]{ИТМО MSE, ФП 2025, Дз 3}
% ------------------------------------------------
...
\begin{document}
    ...
    Репозиторий с исходниками можно скачать с github (\href{https://github.com/fpcourse-materials/lambda-hws}{ссылка}).
    ...
    Населите \textbf{как можно большим} количеством замкнутых термов типы или покажите, как
    сконструировать \textbf{бесконечное} их число ($\alpha\beta\eta$-эквивалентные
